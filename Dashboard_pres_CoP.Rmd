...
Presentation <- template_presentation %>%
  ...
  ph_with(my_pres, value = "Dashboard Automation Project", location = ph_location_type(type = "title")) 
...
Presentation <- template_presentation %>%
  add_slide(layout = "Analytics_Text_Slide_Single", master = "Content Slide White") %>%
  ph_with(value = "Packages Used", location = ph_location_type(type = "title")) %>%
  ph_with(value = c("Tidyverse", 
                    "ggrepel", 
                    "Officer",
                    "NCLRTemplates", 
                    "gt", 
...
Presentation <- template_presentation %>%
  add_slide(layout = "Analytics_Text_Slide_Single", master = "Content Slide White") %>%
  ph_with(value = "Data Ingestion and Tranformation", location = ph_location_type(type = "title")) %>%
...
Presentation <- template_presentation %>%
  add_slide(layout = "Analytics_Text_Slide_Single", master = "Content Slide White") %>%
  ph_with(value = "Visualisation", location = ph_location_type(type = "title")) %>%
...
Presentation <- template_presentation %>%
  add_slide(layout = "Analytics_Text_Slide_Single", master = "Content Slide White") %>%
  ph_with(value = "Presentation Template", location = ph_location_type(type = "title")) %>%
  ph_with(value = c("A template PowerPoint presentation with ICS theme is ingested", 
  "You can create your own ppt templates and load them into the R environment", 
  "Use Slide Master to create and edit layouts, modify or add placeholders"), 
                location = ph_location_type(ph_label = "Text Placeholder 3"))
