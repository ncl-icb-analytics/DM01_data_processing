...
# Read sheet name rules from CSV
sheet_names_df <- read_csv("src/Sheet_name_rules.csv")

sheet_name_rules <- setNames(sheet_names_df$SheetName, sheet_names_df$Provider)
...
process_file <- function(file_path) {
  ...
  # Get the sheet parameters and sheet name based on the provider name
  ...
  colnames(weekly_data) <- column_names
   ...
   # Convert columns to numeric, preserving NAs
