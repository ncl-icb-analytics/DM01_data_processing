...
wide_data <- wide_data %>%
  mutate(across(c(total_dna, unscheduled, dna, patient_cancelled, `patient_declined/refused`), as.numeric))



wide_data <- wide_data %>%
  mutate(across(c(total_dna, unscheduled, dna, patient_cancelled, `patient_declined/refused`), ~ ifelse(is.na(.), "", .)))
