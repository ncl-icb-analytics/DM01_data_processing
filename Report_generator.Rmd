...
#### Endoscopy System Backlog By Provider


```{r}

filtered_data2 <- filter_plot_data(data = data, speciality_group = 'Endoscopy', indicator = 'diagnostic_waiting_list', report_date = params$report_date, duration = 7)
...
summary_table <- flextable(data_summary)


Presentation <- Presentation %>%
  add_slide(layout = "Two Columns Style 1", master = "Content Slide White")  %>%
  ph_with(value = summary_table, location = ph_location_label(ph_label = "Content Placeholder 3"))
```
