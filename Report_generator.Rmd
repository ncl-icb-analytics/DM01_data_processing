...
Presentation <- Presentation %>%
  ...
  ph_with(value = summary_table, location = ph_location_label(ph_label = "Content Placeholder 2"))
...
gt_table2 |> gtsave("gt_table2.png", expand = 10)


Presentation <- Presentation %>%
  ph_with(external_img("gt_table2.png", width = 5, height = 3), location = ph_location_label(ph_label = "Content Placeholder 2"))
...
# Add sentences to the slide using purrr::walk
walk(aggregate_sentences, ~ {
  Presentation <<- ph_with(Presentation, value = .x, location = ph_location_type(type = "Text Placeholder 6"))
})
...
Presentation <- Presentation %>%
  add_slide(layout = "Style 2", master = "Section Slide")  

for (sentence in sentences_list) {
  Presentation <- ph_with(Presentation, value = fpar(ftext(sentence, prop = fp_text(font.size = 12))), location = ph_location_type(type = "Text Placeholder 6"))
}
