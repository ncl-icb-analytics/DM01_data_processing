...
gt_table <- final_table %>%
  ...
  tab_style(style = list(cell_fill(color = "lightpink"), cell_text(weight = "bold", color = "red")),
            locations = lapply(c("Total","GOSH","MEH","NMUH", "RFL","RNOH","UCLH","WH"), builder)) %>%
...
layout_properties(template_presentation, layout = "One Column", master = "Content Slide White")
